...
<div class="w-full md:w-[90%] max-w-screen-md mx-auto bg-white p-6 md:p-8 rounded-xl shadow space-y-6 mt-3">
  ...
  <form class="space-y-4">
    ...
    <div>
      ...
      <input type="tel" class="w-full p-3 rounded bg-gray-100 outline-none" />
    </div>
    <div class="flex flex-col md:flex-row gap-4">
      <div class="flex-1">
        <label class="block font-medium">Birth</label>
        <input type="date" class="w-full p-3 rounded bg-gray-100 outline-none text-gray-700" />
      </div>
      <div class="flex-1">
